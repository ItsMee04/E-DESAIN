<template>
    <div class="min-h-screen w-full flex items-center justify-center bg-gray-50 p-4 font-sans antialiased">
        <div class="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl border border-gray-100">
            <!-- Header & Logo -->
            <div class="mb-10 text-center flex flex-col items-center">
                <div class="w-20 h-20 mb-5 flex items-center justify-center p-1">
                    <img src="/public/assets/img/logo.png" alt="Logo RSU Wiradadi Husada"
                        class="w-full h-full object-contain" />
                </div>
                <div class="flex flex-col items-center gap-1">
                    <span class="text-xs font-semibold uppercase tracking-widest text-[#B20600]">
                        RSU Wiradadi Husada
                    </span>
                    <div class="flex items-center gap-2">
                        <Palette :size="28" class="text-blue-950" />
                        <h1 class="text-4xl font-extrabold tracking-tighter text-blue-950">
                            E-Desain
                        </h1>
                    </div>
            ...
            <form class="space-y-6" @submit.prevent="handleLogin">
                ...
                <div class="space-y-1.5">
                    <label for="username" class="block text-sm font-medium text-blue-950">
                        Username
                    </label>
                    <div class="relative">
                        <div
                ...
                <!-- Password -->
                <div class="space-y-1.5">
                    <label for="password" class="block text-sm font-medium text-blue-950">
                        Kata Sandi
                    </label>
                    <div class="relative">
                        <div
                ...
                <!-- General Error -->
                <div v-if="errors.general" class="p-3 rounded-xl bg-red-50 border border-red-200 text-sm text-red-700">
                    {{ errors.general }}
                </div>
                <div class="flex items-center justify-between gap-2">
                    ...
                    <a href="#" class="text-sm font-semibold text-[#B20600] hover:underline transition">
                        Lupa kata sandi?
                    </a>
                </div>
                <!-- Login Button -->
                <button type="submit" :disabled="isLoading"
                    ...
                    <!-- Loading -->
                    <svg v-if="isLoading" class="animate-spin h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg"
            ...
            <!-- Footer -->
            <div class="mt-12 text-center text-xs text-blue-950/50 border-t border-gray-100 pt-6">
