<template>
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h3 class="text-lg font-bold text-blue-950">Data Pengguna</h3>
                <p class="text-xs text-blue-950/60">Pengelolaan daftar pengguna sistem</p>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm text-blue-950">
                ...
                <tbody v-else-if="paginatedItems.length === 0" class="divide-y divide-gray-100">
                    <tr>
                        <td colspan="6" class="text-center py-6 text-xs text-blue-950/50">
...
<script setup>
import { ShieldCheck, Search, Plus, RotateCw, Pencil, Trash2 } from 'lucide-vue-next';
